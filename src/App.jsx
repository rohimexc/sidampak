    ...
    <div className="bg-white rounded-t-[2rem] sm:rounded-[2rem] max-h-[90vh] w-full sm:max-w-lg md:max-w-xl flex flex-col shadow-2xl animate-in slide-in-from-bottom-full sm:slide-in-from-bottom-8 duration-300 relative overflow-hidden">
      <div className="flex items-center justify-between px-6 pt-6 pb-4 border-b border-slate-100 shrink-0 bg-white">
        <h3 className="text-lg font-bold text-slate-800 flex items-center gap-2">
          <HelpCircle className="w-5 h-5 text-indigo-500 shrink-0" /> Status Logbook
        </h3>
...
const ReviewerView = ({ reviewerToken, showToast }) => {
  ...
  return (
    <div className="flex flex-col h-screen bg-slate-50 relative overflow-hidden font-sans">
      ...
      <div className="bg-slate-900 text-white pt-10 pb-20 rounded-b-[2.5rem] shadow-xl relative shrink-0 w-full z-10">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          <img src="/untad.png" alt="Logo UNTAD" className="h-12 sm:h-16 w-auto mb-4 sm:mb-5 object-contain" />

          <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold tracking-tight">Portal Reviewer</h1>
          {reviewerInfo?.nama && (
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-5 mt-6 sm:mt-8 max-w-3xl">
      ...
      <div className="px-4 sm:px-6 lg:px-8 -mt-6 relative z-20 mb-3 shrink-0 w-full">
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg shadow-slate-900/5 p-1 flex gap-1 border border-slate-100 max-w-2xl">
            <button
